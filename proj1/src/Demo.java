    ...
    public static void main(String[] args) {
        ...
        */
        ...
        while(run){
            ...
            System.out.println("  Press 9 to undo the previous command");
            ...
            switch (choice){
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("=== Enter the book name and quantity of copies that you want to sell:");
                    Scanner sell_scan = new Scanner(System.in);
